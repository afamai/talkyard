...
<p>/End of page.</p>
  ...
  makeBlogPostIndexPageHtml(ps: { localHostname?: St, urlA: St, urlB: St, urlC: St,
    ...
    const html = `
        ...
        <ol>${''
          /* Trying with a bit diifferent HTML structure below, in each <li>
                  — everything should work fine  */}
          <li>
            <a href="${ps.urlA}">
              A:
              <span class="ty_NumCmts ty_NumComments"></span> comments,
              <span class="ty_NumLikeVotes"></span> likes, href: ${ps.urlA}<br>
            </a>
          </li>
          <li>
            <a href="${ps.urlB}">
              ...
              <span class="ty_NumLikeVotes"></span> likes, href: ${ps.urlB}<br>
            </a>
          </li>
          <li>
            <a href="${ps.urlC}">C: </a>
            <a href="${ps.urlC}#comments-section" class="ty_NumCmts"></a> comments,
            <a href="${ps.urlC}#comments-section" class="ty_NumLikeVotes"></a> likes,
          ...
          <li>
            ...
            <div href="http://wrong-url.example.com">
              ...
              <a href="${ps.urlD}"><span class="ty_NumLikes"></span></a> likes,
              url: ${ps.urlD}
            </div>
          </li>
          <li>
